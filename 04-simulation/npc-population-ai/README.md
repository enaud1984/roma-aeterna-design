# NPC, Popolazione e AI

## Scopo

Definire l'architettura documentale del dominio **NPC, Popolazione e AI** e i confini dei suoi documenti canonici.
...
- [Modello della Popolazione](population-model.md)
- [Livelli di Simulazione](simulation-levels.md)
- [Architettura AI](ai-architecture.md)
- [AI dei Bisogni](needs-ai.md)
- [Routine](routines.md)
