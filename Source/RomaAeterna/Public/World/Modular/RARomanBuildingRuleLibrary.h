...
public:
	...
	UFUNCTION(BlueprintCallable, Category="Roma Aeterna|Utilities") static FRARomanGenerationResult GenerateBathComplexPlan(const FRARomanBuildingParameters& Parameters);
	UFUNCTION(BlueprintCallable, Category="Roma Aeterna|Utilities") static FRARomanGenerationResult GeneratePalaestraPlan(const FRARomanBuildingParameters& Parameters);
	UFUNCTION(BlueprintCallable, Category="Roma Aeterna|Utilities") static FRARomanGenerationResult GenerateCastellumAquaePlan(const FRARomanBuildingParameters& Parameters);
	UFUNCTION(BlueprintCallable, Category="Roma Aeterna|Utilities") static FRARomanGenerationResult GenerateAqueductSectionPlan(const FRARomanBuildingParameters& Parameters);
	UFUNCTION(BlueprintCallable, Category="Roma Aeterna|Utilities") static FRARomanGenerationResult GenerateSewerSectionPlan(const FRARomanBuildingParameters& Parameters);
	UFUNCTION(BlueprintCallable, Category="Roma Aeterna|Utilities") static FRARomanGenerationResult GeneratePublicFountainPlan(const FRARomanBuildingParameters& Parameters);
	UFUNCTION(BlueprintCallable, Category="Roma Aeterna|Utilities") static FRARomanGenerationResult GenerateCisternPlan(const FRARomanBuildingParameters& Parameters);
	UFUNCTION(BlueprintCallable, Category="Roma Aeterna|Utilities") static FRARomanGenerationResult GenerateWellPlan(const FRARomanBuildingParameters& Parameters);
	UFUNCTION(BlueprintCallable, Category="Roma Aeterna|Utilities") static FRARomanGenerationResult GenerateTinctoriaPlan(const FRARomanBuildingParameters& Parameters);
	UFUNCTION(BlueprintCallable, Category="Roma Aeterna|Utilities") static FRARomanGenerationResult GenerateTanneryPlan(const FRARomanBuildingParameters& Parameters);
	UFUNCTION(BlueprintCallable, Category="Roma Aeterna|Utilities") static FRARomanGenerationResult GenerateTextileWorkshopPlan(const FRARomanBuildingParameters& Parameters);
	UFUNCTION(BlueprintCallable, Category="Roma Aeterna|Utilities") static FRARomanGenerationResult GenerateMetalWorkshopPlan(const FRARomanBuildingParameters& Parameters);
	UFUNCTION(BlueprintCallable, Category="Roma Aeterna|Utilities") static FRARomanGenerationResult GeneratePotteryWorkshopPlan(const FRARomanBuildingParameters& Parameters);
	UFUNCTION(BlueprintCallable, Category="Roma Aeterna|Utilities") static FRARomanGenerationResult GenerateOilWorkshopPlan(const FRARomanBuildingParameters& Parameters);
	UFUNCTION(BlueprintCallable, Category="Roma Aeterna|Utilities") static FRARomanGenerationResult GenerateWineryPlan(const FRARomanBuildingParameters& Parameters);
	UFUNCTION(BlueprintCallable, Category="Roma Aeterna|Utilities") static FRARomanGenerationResult GeneratePressingWorkshopPlan(const FRARomanBuildingParameters& Parameters);
	UFUNCTION(BlueprintCallable, Category="Roma Aeterna|Utilities") static FRARomanGenerationResult GenerateStandaloneOvenPlan(const FRARomanBuildingParameters& Parameters);
	UFUNCTION(BlueprintCallable, Category="Roma Aeterna|Utilities") static FRARomanGenerationResult GenerateHorreaPlan(const FRARomanBuildingParameters& Parameters);
	UFUNCTION(BlueprintCallable, Category="Roma Aeterna|Utilities") static FRARomanGenerationResult GenerateUrbanGardenPlan(const FRARomanBuildingParameters& Parameters);
	UFUNCTION(BlueprintCallable, Category="Roma Aeterna|Utilities") static FRARomanGenerationResult GenerateServiceYardPlan(const FRARomanBuildingParameters& Parameters);
