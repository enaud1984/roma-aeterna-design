...
|---|---|---|---|---|
| 1 | intonaco, basolato, murature e tetti; MAT-001, ROAD-001, ARCH-004/003, ROOF-001 | cartelle locali ignorate `Content/ThirdParty/{Fab,Megascans}/<Vendor>`; mapping testuale versionato | licenza, UE 5.8, scala, pivot, tile, collisione, LOD/Nanite, memoria, audit, build e Automation | totale `NOT_VERIFIED`; nessun binario versionato; rollback del solo mapping/configurazione |
...
Ogni commit include soltanto registro provenienza, configurazione/mapping testuale, test e documentazione. Ricevute, credenziali e file binari esterni restano locali. I vendor asset non si rinominano in-place; i placeholder versionati restano fallback. Stato: `ASSET_IMPORT_PLAN_COMPLETED`, `LOCAL_ASSET_ONLY_STRATEGY`.
