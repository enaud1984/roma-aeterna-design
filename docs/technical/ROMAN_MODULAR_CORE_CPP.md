...
## Aggiornamento Prompt 21 — test categorie runtime

I test standard del core sono stati ampliati per verificare categorie attese nei layout, conteggi per categoria, bounds coerenti, ordine stabile dei placement e assenza di accumulo dopo chiamate ripetute. Il core resta indipendente da Unreal; la visualizzazione avviene nell'adapter runtime.
