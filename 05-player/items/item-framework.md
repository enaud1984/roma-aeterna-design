# Framework degli Oggetti

## Scopo

Definire la futura specifica canonica di **Framework degli Oggetti**.

## Descrizione

Definisce identità, categorie, proprietà, qualità e ciclo di vita.
...
- [Esperienza del giocatore](../player-experience.md)
